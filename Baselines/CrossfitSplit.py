...
train_dir = './Crossfit/Train/'
val_dir = './Crossfit/Test/'
idx = 0
data_dict = {}
train_data_dict = {}
val_data_dict = {}
...
# Train
for ppl in os.listdir(train_dir):
    ppl_action_dir = os.path.join(train_dir, ppl)
...
# Val
for ppl in os.listdir(val_dir):
    ppl_action_dir = os.path.join(val_dir, ppl)
    exemplar_dir = os.path.join(ppl_action_dir, 'Session 1')
    all_query_dir = os.path.join(ppl_action_dir, 'Session 2')
    exemplar_name = os.listdir(exemplar_dir)[0]
    exemplar_dir = os.path.join(exemplar_dir, exemplar_name)
